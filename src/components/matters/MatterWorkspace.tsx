      ...
      <div className="bg-slate-900/90 border-b border-slate-800 px-6 py-4">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          <div className="space-y-1">
            ...
            <h1 className="text-xl font-bold font-legal-heading text-slate-100 tracking-tight">
              {matter.title}
            </h1>
          </div>
          ...
          <div className="flex items-center gap-3">
            {matter.hasActiveHold && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-rose-950/50 border border-rose-800/60 rounded text-xs text-rose-300 hover:bg-rose-900/50 transition-colors font-medium"
              >
        ...
        <div className="flex items-center gap-1 mt-4 overflow-x-auto border-t border-slate-800/80 pt-2 no-scrollbar">
          {SUB_TABS.map((tab) => {
            const Icon = tab.icon;
